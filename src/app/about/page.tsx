  ...
  return (
    <main className="min-h-screen bg-aegis-black px-6 py-10 text-aegis-silver">
      <div className="mx-auto max-w-5xl">
        <div className="mb-8">
          <Link href="/" className="inline-flex items-center gap-2 font-body text-sm text-aegis-gray hover:text-aegis-teal">
            <ArrowLeft size={16} />
            Back to dashboard
          </Link>
        </div>
          ...
          <Card>
            ...
            <ul className="space-y-3">
              {principles.map((principle) => (
                <li key={principle} className="flex gap-3 font-body text-sm text-aegis-gray">
                  <CheckCircle2 className="mt-0.5 shrink-0 text-aegis-teal" size={17} />
                  <span>{principle}</span>
                </li>
              ))}
            </ul>
          ...
          <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            <div>
              ...
              <p className="mt-2 font-body text-sm text-aegis-gray">
                Start with sample mode, paste manual page text, or run a live URL through Firecrawl.
              </p>
            </div>
            <Link href="/">
